    ...
    return (
        <div className="portfolio-head-wrapper">
            ...
            <div className="portfolio-head-inner-wrapper">
                <Project img={'/portfolio.png'} category={'Web Dev.'} txt={'This is my person portfolio website (v1). Built with Next Js.'} project_name={'Ayomide Ishola Portfolio Website - (v1)'} url={'https://ay4codes.vercel.app/'} alt={'My Portfolio preview image'} />
                ...
                <Project img={'/labongoes.png'} category={'Web Dev.'} txt={'A shopping cart system that sends customer order to the receptionist email. Built with React Js.'} project_name={'A shopping cart system'} url={'https://labongoes.vercel.app/'} alt={'Shopping cart system preview image'} />
